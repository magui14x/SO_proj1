...
### `list_recycled()`
![Data Flow Diagrams](diagrams/dataflow_list.png)

### `restore_file()`
![Data Flow Diagrams](diagrams/dataflow_restore.png)
...
### `delete_file()`
![Flowcharts](diagrams/flowchart_delete.png)

### `list_recycled()`
![Flowcharts](diagrams/flowchart_list.png)

### `restore_file()`
![Flowcharts](diagrams/flowchart_restore.png)

### `search_recycled()`
![Flowcharts](diagrams/flowchart_search.png)

### `empty_recyclebin()`
![Flowcharts](diagrams/flowchart_empty.png)
